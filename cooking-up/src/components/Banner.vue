<template>
    ...
    <div class="apresentacao">
      <img src="../assets/img/logo.svg" alt="logo do cooking up" class="logo" />
    ...
    <img src="../assets/img/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e está apoiando um celular entre seu rosto e ombro." class="foto-banner">
  </header>
</template>
